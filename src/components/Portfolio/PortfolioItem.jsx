...
const PortfolioItem = (props) => {
    return (
        <div className="w-full md:w-4/5 md:mx-auto flex flex-col md:flex-row justify-around md:text-left text-center mt-10 shadow-2xl rounded-xl p-5 items-center">
