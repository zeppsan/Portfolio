...
const Popup = (props) => {
    return (
        ...
        className="h-screen w-full bg-black/80 fixed left-0 top-0 flex justify-center items-center">
            ...
            className=" w-11/12 lg:w-4/5 xl:w-1/3 h-auto pb-5 bg-white rounded-xl shadow-xl flex flex-col px-10 text-center">
                ...
                <button className="mt-10 rounded-xl shadow-md bg-slate-300 text-slate-100 hover:text-white hover:bg-slate-400 transition-all gover:shadow-xl py-2"  onClick={props.close}>Close</button>
            </motion.div>
        </motion.div>
    );
}
